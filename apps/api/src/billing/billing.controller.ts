...
export class BillingController {
  ...
  createCheckout(
    ...
    return this.billingService.createCheckoutSession(orgId, body.plan, body.returnUrl)
  }
  ...
  stripeWebhook(
    ...
    return this.billingService.handleWebhook(req.rawBody ?? Buffer.alloc(0), sig)
  }
}
